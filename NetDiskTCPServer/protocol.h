...
#define LOGIN_FAILED "login failed,Account or password error, repeated login"

#define LOGOUT_OK "logout ok"                            //注销
...
#define CREATE_DIR_OK "create dir ok"                    // 新建、删除文件夹
...
#define DELETE_FILEORDIR_OK "delete file or dir ok"                  // 删除文件夹
#define DELETE_FILEORDIR_FAILED "delete file  or dir failed"
...
#define AES_ECB_FILL_BYTE_SIZE 16                               //秘钥长度
...
//添加好友状态
enum ADDFRIEND_STATE{
    FRIEND_INDWELL_OFFLINE, //对方存在不在线
    FRIEND_INDWELL_ONLINE,  //对方存在在线
    FRIEND_NO_INDWELL,      //用户不存在
    FRIEND_IS_FRIEND,       //已是好友
    FRIEND_REQUEST_ERROR,   //请求错误
};
...
enum ENUM_MSG_TYPE
{
    ...
    ENUM_MSG_TYPE_LOGOUT_RESPOND,       //注销处理
    ...
    ENUM_MSG_TYPE_DOWNLOAD_FILE_BYTE_TIPS, // 客户端下载文件填充字节数提示
    ENUM_MSG_TYPE_UPLOAD_FILE_BYTE_TIPS, // 客户端上传文件填充字节数提示
